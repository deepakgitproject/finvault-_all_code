        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RewardPointsGranted = table.Column<int>(type: "int", nullable: true),
                    CompensationReason = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PaymentSagas", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentSagas_PaymentId",
                table: "PaymentSagas",
                column: "PaymentId",
                unique: true);
